...
<ul class="menu_list">
    <li>
        <a href="inicio3.php"> Início </a>
    </li>

    <li>
        <a href="series3.php"> Séries </a>
    </li>

    <li>
        <a href="filmes3.php"> Filmes </a>
    </li>

    <li>
        <a href="podcasts3.php"> Podcasts </a>
    </li>
    ...
    <img src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/64623a33850498.56ba69ac2a6f7.png" style="width: 30px; float: right; margin-right: 20px;">
    </a>
